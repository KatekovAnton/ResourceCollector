...
{
    public enum Axis { X, Y, Z, XoY, YoZ, XoZ , none};
    ...
    public class MoveArrows
    {
        ...
        public static bool needdrawarrowmeshes = false;
      ...
      //  public float _MOVEMULTIPLYER;
        ...
        public MoveArrows(bool primary=true)
        {
            ...
            if (Xvertices == null)
            {
                ...
                Xvertices = new VertexPositionColor[]{
                    new VertexPositionColor(new Vector3(-0.5000001f,-0.4999999f,-0.5f),Color.White),
                    new VertexPositionColor( new Vector3(0.4862234f,0.5059329f,-0.5f),Color.White),
                    new VertexPositionColor( new Vector3(10f,0.5f,-0.5f),Color.White),
                    new VertexPositionColor( new Vector3(10f,-0.5000001f,-0.5f),Color.White),
                    new VertexPositionColor( new Vector3(10f,0.5f,-0.5f),Color.White),
                    new VertexPositionColor( new Vector3(0.4862234f,0.5059329f,-0.5f),Color.White),
                    new VertexPositionColor( new Vector3(0.5000001f,0.5f,0.5f),Color.White),
                    new VertexPositionColor( new Vector3(10f,0.5f,0.5f),Color.White),
                    new VertexPositionColor( new Vector3(10f,0.5f,0.5f),Color.White),
                    new VertexPositionColor( new Vector3(0.5000001f,0.5f,0.5f),Color.White),
                    new VertexPositionColor( new Vector3(0.5f,-0.4999999f,0.5f),Color.White),
                    new VertexPositionColor( new Vector3(10f,-0.5000001f,0.5f),Color.White),
                    new VertexPositionColor( new Vector3(10f,-0.5000001f,-0.5f),Color.White),
                    new VertexPositionColor( new Vector3(10f,-0.5000001f,0.5f),Color.White),
                    new VertexPositionColor( new Vector3(0.5f,-0.4999999f,0.5f),Color.White),
                ...
                Yvertices = new VertexPositionColor[]{
                    new VertexPositionColor( new Vector3(-0.5f,-0.5f,-0.5f),Color.White),
                    new VertexPositionColor( new Vector3(-0.5f,0.5f,0.5f),Color.White),
                    new VertexPositionColor( new Vector3(-0.5f,10f,0.5f),Color.White),
                    new VertexPositionColor( new Vector3(-0.5f,10f,-0.5f),Color.White),
                    new VertexPositionColor( new Vector3(-0.5f,10f,0.5f),Color.White),
                    new VertexPositionColor( new Vector3(-0.5f,0.5f,0.5f),Color.White),
                    new VertexPositionColor( new Vector3(0.5f,0.5f,0.5f), Color.White),
                ...
                Zvertices = new VertexPositionColor[]{
                    new VertexPositionColor( new Vector3(-0.5f,-0.5f,-0.5f),Color.White),
                    new VertexPositionColor( new Vector3(0.5f,-0.5f,0.5f),Color.White),
                    new VertexPositionColor( new Vector3(0.5f,-0.5f,10f),Color.White),
                    new VertexPositionColor( new Vector3(-0.5f,-0.5f,10f),Color.White),
                    new VertexPositionColor( new Vector3(0.5f,-0.5f,10f),Color.White),
                    new VertexPositionColor( new Vector3(0.5f,-0.5f,0.5f),Color.White),
                    new VertexPositionColor( new Vector3(0.5f,0.5f,0.5f),Color.White),
                ...
                XoYvertices = new VertexPositionColor[]{
                    ...
                    new VertexPositionColor(new Vector3(0f, km, 0f),Color.White),
                    new VertexPositionColor(new Vector3(km, km, 0f),Color.White),
                    new VertexPositionColor(new Vector3(km, 0f, 0f),Color.White)
                    };
                XoZvertices = new VertexPositionColor[]{
                    new VertexPositionColor(new Vector3(0f, 0f, 0f), Color.White),
                    new VertexPositionColor(new Vector3(km, 0f, 0f), Color.White),
                    new VertexPositionColor(new Vector3(km, 0f, km), Color.White),
                    new VertexPositionColor(new Vector3(0f, 0f, km), Color.White)
                    };
                YoZvertices = new VertexPositionColor[]{
                    new VertexPositionColor(new Vector3(0f, km, 0f), Color.White),
                    new VertexPositionColor(new Vector3(0f, 0f, 0f), Color.White),
                    new VertexPositionColor(new Vector3(0f, 0f, km), Color.White),
                    new VertexPositionColor(new Vector3(0f, km, km), Color.White)
                    };

                XoYPlaneVertices = new VertexPositionColor[]{
                    new VertexPositionColor(new Vector3(-k*10, -k*10, 0f) ,Color.White),
                    new VertexPositionColor(new Vector3(-k*10, k*10, 0f),Color.White),
                    new VertexPositionColor(new Vector3(k*10, k*10, 0f),Color.White),
                    new VertexPositionColor(new Vector3(k*10, -k*10, 0f),Color.White)
                    };
                XoZPlaneVertices = new VertexPositionColor[]{
                    new VertexPositionColor(new Vector3(-k*10, 0f, -k*10), Color.White),
                    new VertexPositionColor(new Vector3(k*10, 0f, -k*10), Color.White),
                    new VertexPositionColor(new Vector3(k*10, 0f, k*10), Color.White),
                    new VertexPositionColor(new Vector3(-k*10, 0f, k*10), Color.White)
                    };
                YoZPlaneVertices = new VertexPositionColor[]{
                    new VertexPositionColor(new Vector3(0f, k*10, -k*10), Color.White),
                    new VertexPositionColor(new Vector3(0f, -k*10, -k*10), Color.White),
                    new VertexPositionColor(new Vector3(0f, -k*10, k*10), Color.White),
                    new VertexPositionColor(new Vector3(0f, k*10, k*10), Color.White)
                    };

                MoveArrowPoints = new VertexPositionColor[]{
                    new VertexPositionColor(new Vector3(),InterfaceColors.XAxisColor),//0x //0
        ...
        public void DrawPivot(Microsoft.Xna.Framework.Graphics.SpriteBatch sprite)
        {
            ...
            GameEngine.Device.DrawUserIndexedPrimitives<VertexPositionColor>(
                     PrimitiveType.LineList, MoveArrowPoints, 0, MoveArrowPoints.Length, MoveArrowsIndices, 0, MoveArrowsIndices.Length / 2);
